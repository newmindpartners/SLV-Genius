...
import {assets as gensxPreprodAsset} from '../asset';
...
const gensxPreprodProject: Seed.Project = {
  projectId: '3329fc1f-a3f3-4c00-a9cf-9f7b4e8b778c',

  name: gensxPreprodAsset.gensx.longName || '',
  imageLogoUrl: gensxPreprodAsset.gensx.iconUrl || '',
  ...
  assetId: gensxPreprodAsset.gensx.assetId,
};

export const project = gensxPreprodProject;
