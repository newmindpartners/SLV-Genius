...
import {stakingProject as gensMainnetStakingProject} from '~/seed/data/projects/gens/stakingGroup/mainnet/staking-project';
...
const getStakingProjectNftId = (type: string, subType: string) => {
  ...
  if (stakingProjectNftId) {
    ...
    throw new Error(
      'Provisioning GENS stakingGroup mainnet StakingProjectNft: subType not accounted for'
    );
  }
};
...
export const stakingProjectNfts = getStakingProjectNfts(
  gensMainnetStakingProject.stakingProjectId
);
