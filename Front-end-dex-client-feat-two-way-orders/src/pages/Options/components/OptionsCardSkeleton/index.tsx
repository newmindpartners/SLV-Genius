...
export const OptionsCardSkeleton = () => (
  <OptionsCardSkeleton.Wrapper>
    <OptionsCardSkeleton.Heading
      container
      flexWrap="nowrap"
    ...
    <OptionsCardSkeleton.SkeletonContent container>
      ...
      <OptionsCardSkeleton.Line mb="28px" height="1px" width="100%" />
    ...
    </OptionsCardSkeleton.SkeletonContent>
  </OptionsCardSkeleton.Wrapper>
);

OptionsCardSkeleton.Wrapper = styled(Grid)(({ theme }) => ({
...
OptionsCardSkeleton.Heading = styled(Grid)({
  padding: '20px 28px',
  borderBottom: '1px solid #2D3758',
  borderRadius: '20px 20px 0px 0px',
});

OptionsCardSkeleton.SkeletonContent = styled(Grid)({
...
OptionsCardSkeleton.Line = styled(Grid)({
