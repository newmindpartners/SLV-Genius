import { Grid, List, ListItemButton, Avatar as MUIAvatar, styled } from '@mui/material';
import { shouldForwardProp } from '@mui/system';
import { map } from 'lodash';
import { FC, ReactElement } from 'react';
import { DescriptionText } from '~/pages/Swap/components/OrderCard/components/TextFieldIconSelect/DropdownOptions';
...
const SmartVaultDropdownOptions: FC<DropdownOptionsProps> = ({
  selectedOption,
  displayedOptions,
  handleOptionClick,
}): ReactElement => (
...
export default SmartVaultDropdownOptions;
